...
public class KdtApiProtocol {
    ...
    private static String hash(String signContent){
        System.out.println("sign原始:"+signContent);
        signContent="testapp_idtestformatjsonmethodkdt.item.getnum_iid3838293428sign_methodmd5timestamp2013-05-06 13:52:03v1.0test";
    	String hashResult = "";
		try {
        ...
        System.out.println("sign结果："+hashResult);
        return hashResult;
    }
}
